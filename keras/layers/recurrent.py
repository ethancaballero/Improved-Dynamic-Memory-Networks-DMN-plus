...
class DropoutGRU(Recurrent):
    def __init__(self, input_dim, output_dim=128,
        ...
        print "DropoutGRU version 0.0.0.12"
...
class NaiveDropoutGRU(Recurrent):
    def __init__(self, input_dim, output_dim=128,
        ...
        print "NaiveDropoutGRU version 0.0.0.12"
        self.srng = RandomStreams(seed=np.random.randint(10e6))
        self.input_dim = input_dim
        self.output_dim = output_dim
        self.truncate_gradient = truncate_gradient
...
class DropoutLSTM(Recurrent):
    def __init__(self, input_dim, output_dim=128,
        ...
        print "DropoutLSTM version 0.0.0.12"
        self.srng = RandomStreams(seed=np.random.randint(10e6))
        self.input_dim = input_dim
        self.output_dim = output_dim
        self.truncate_gradient = truncate_gradient
...
class MultiplicativeGaussianNoiseLSTM(Recurrent):
    ...
    def get_output(self, train=False):
        ...
        print "MultiplicativeGaussianNoiseLSTM version 0.0.0.12"
...
class NaiveDropoutLSTM(Recurrent):
    ...
    def get_output(self, train=False):
        ...
        self.train = train
        print "NaiveDropoutLSTM version 0.0.0.26"
        retain_prob_W = 1. - self.p_W[0]
        retain_prob_U = 1. - self.p_U[0]
        if train:
